...
(function() {
    ...
    var MOVIES = [
        ...
        { id:'anesmami', name:'فيلم الانسة مامي', file:'https://youtu.be/ZO4TuiBs08I', genre:'كوميدي/مصري', tags:['الانسة مامي','مامي','كوميدي','مصري','فيلم'] },
        { id:'helmomr', name:'فيلم حلم العمر', file:'https://youtu.be/JZi5sLV17rA', genre:'رومانسي/مصري', tags:['حلم العمر','حلم','العمر','رومانسي','مصري','فيلم'] },
        { id:'asalaswd', name:'فيلم عسل اسود', file:'https://youtu.be/Bhdp9B0GbV8', genre:'دراما/كوميدي', tags:['عسل اسود','عسل','اسود','احمد حلمي','دراما','كوميدي','مصري'] },
        { id:'erhabkabab', name:'فيلم الارهاب والكباب', file:'https://youtu.be/wRfnxwd8hZY', genre:'كوميدي/مصري', tags:['الارهاب والكباب','ارهاب','كباب','عادل امام','كوميدي','مصري'] },
        { id:'antarshaddad', name:'فيلم عنتر ابن شداد', file:'https://youtu.be/fEppFPmeagI', genre:'تاريخي/مصري', tags:['عنتر','ابن شداد','تاريخي','مصري','كلاسيك'] },
        { id:'ahlamomrna', name:'فيلم احلام عمرنا', file:'https://youtu.be/wDbxK4qulYA', genre:'رومانسي/مصري', tags:['احلام عمرنا','احلام','رومانسي','مصري'] },
        { id:'lakhmaras', name:'فيلم لخمة راس', file:'https://youtu.be/80mAtao1yCA', genre:'كوميدي/مصري', tags:['لخمة راس','لخمة','كوميدي','مصري'] },
        { id:'meshmohandis', name:'فيلم المش مهندس حسن', file:'https://youtu.be/p8oK5kU-aIA', genre:'كوميدي/مصري', tags:['المش مهندس حسن','مهندس','حسن','كوميدي','مصري'] },
        { id:'code36', name:'فيلم كود 36', file:'https://youtu.be/A1JHtzMq3zI', genre:'اكشن/مصري', tags:['كود 36','كود','اكشن','مصري'] },
        { id:'ibnhamido', name:'فيلم ابن حميدو', file:'https://youtu.be/43tzuCsmkhI', genre:'كوميدي/مصري', tags:['ابن حميدو','حميدو','اسماعيل يس','كوميدي','مصري','كلاسيك'] },
        { id:'ta2yetekhfa', name:'فيلم سر طاقية الاخفاء', file:'https://youtu.be/K1QcSIvxsJI', genre:'كوميدي/مصري', tags:['سر طاقية الاخفاء','طاقية','اخفاء','كوميدي','مصري','كلاسيك'] },
        { id:'ismaeelyasostol', name:'فيلم اسماعيل يس في الاسطول', file:'https://youtu.be/rGecNvI-4-Y', genre:'كوميدي/مصري', tags:['اسماعيل يس','الاسطول','كوميدي','مصري','كلاسيك'] },
        { id:'katebtelidam', name:'فيلم كتيبة الاعدام', file:'https://youtu.be/lhBSOeEPcMU', genre:'اكشن/مصري', tags:['كتيبة الاعدام','كتيبة','اعدام','اكشن','مصري'] },
        { id:'elafareet', name:'فيلم العفاريت', file:'https://youtu.be/hesFbe-G1f4', genre:'كوميدي/مصري', tags:['العفاريت','عفاريت','كوميدي','مصري'] },
        { id:'babelwazir', name:'فيلم على باب الوزير', file:'https://youtu.be/LyC-A0UkCMs', genre:'كوميدي/مصري', tags:['على باب الوزير','الوزير','عادل امام','كوميدي','مصري'] },
        { id:'rasasa', name:'فيلم الرصاصة لا تزال في جيبي', file:'https://youtu.be/ytFbourO1Pw', genre:'اكشن/مصري', tags:['الرصاصة','جيبي','اكشن','مصري','تشويق'] },
        { id:'waislamah', name:'فيلم وا اسلاماه', file:'https://youtu.be/aBBlNtUHrEk', genre:'تاريخي/مصري', tags:['وا اسلاماه','اسلاماه','تاريخي','مصري','كلاسيك'] },
        { id:'elmawled', name:'فيلم المولد', file:'https://youtu.be/5VAhJzgtQA4', genre:'كوميدي/مصري', tags:['المولد','مولد','كوميدي','مصري'] },
        { id:'eshaaethob', name:'فيلم اشاعة حب', file:'https://youtu.be/_PjWqLuI-TQ', genre:'رومانسي/مصري', tags:['اشاعة حب','اشاعة','حب','رومانسي','مصري','كلاسيك'] },
        { id:'aqwarigal', name:'فيلم اقوى الرجال', file:'https://youtu.be/Cp8L5bNk5NQ', genre:'اكشن/مصري', tags:['اقوى الرجال','اقوى','رجال','اكشن','مصري'] },
        { id:'zawga13', name:'فيلم الزوجة 13', file:'https://youtu.be/ynMUxO7yY6s', genre:'كوميدي/مصري', tags:['الزوجة 13','الزوجة','كوميدي','مصري','كلاسيك'] },
        { id:'mazon2', name:'فيلم البعض لا يذهب للمأذون مرتين', file:'https://youtu.be/2VJCN3aCKeg', genre:'كوميدي/مصري', tags:['البعض لا يذهب','المأذون','كوميدي','مصري'] },
        { id:'mashbooh', name:'فيلم المشبوه', file:'https://youtu.be/Wmqfiny64ds', genre:'اكشن/دراما', tags:['المشبوه','مشبوه','عادل امام','اكشن','دراما','مصري'] }
    ];
    ...
    var SYSTEM_PROMPT = [
        ...
        '',
        '## مكتبة الأفلام (29 فيلم):',
        '- فيلم برشامة 2026 (كوميدي)',
        '- فيلم الكلام على ايه (مصري)',
        '- فيلم كولونيا (دراما)',
        '- فيلم ان غاب القط (كوميدي)',
        '- فيلم عيال حبيبة (كوميدي/رومانسي)',
        '- فيلم افواه وارانب (دراما/كلاسيك)',
        '- فيلم الانسة مامي (كوميدي)',
        '- فيلم حلم العمر (رومانسي)',
        '- فيلم عسل اسود (دراما/كوميدي)',
        '- فيلم الارهاب والكباب (كوميدي)',
        '- فيلم عنتر ابن شداد (تاريخي)',
        '- فيلم احلام عمرنا (رومانسي)',
        '- فيلم لخمة راس (كوميدي)',
        '- فيلم المش مهندس حسن (كوميدي)',
        '- فيلم كود 36 (اكشن)',
        '- فيلم ابن حميدو (كوميدي/كلاسيك)',
        '- فيلم سر طاقية الاخفاء (كوميدي/كلاسيك)',
        '- فيلم اسماعيل يس في الاسطول (كوميدي/كلاسيك)',
        '- فيلم كتيبة الاعدام (اكشن)',
        '- فيلم العفاريت (كوميدي)',
        '- فيلم على باب الوزير (كوميدي)',
        '- فيلم الرصاصة لا تزال في جيبي (اكشن)',
        '- فيلم وا اسلاماه (تاريخي)',
        '- فيلم المولد (كوميدي)',
        '- فيلم اشاعة حب (رومانسي/كلاسيك)',
        '- فيلم اقوى الرجال (اكشن)',
        '- فيلم الزوجة 13 (كوميدي)',
        '- فيلم البعض لا يذهب للمأذون مرتين (كوميدي)',
        '- فيلم المشبوه (اكشن/دراما)',
        '',
